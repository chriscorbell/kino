export const enUS = {
  ...
  details: {
    ...
    markEpisodeWatched: (episode: string) => `Mark ${episode} as watched`,
    markEpisodeUnwatched: (episode: string) => `Mark ${episode} as unwatched`,
    savingWatched: 'Saving watched state…',
