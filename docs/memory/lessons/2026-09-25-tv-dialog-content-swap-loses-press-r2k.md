...
Verified: 2026-09-25
Source: `TvAddonsTest` while building add-on installation; each step is its own `ChoiceDialog` in `apps/android-tv/app/src/main/java/app/kino/tv/TvAddons.kt` (it replaced `ConfirmDialog` in #230).
